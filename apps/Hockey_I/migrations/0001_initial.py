# Generated by Django 2.2 on 2020-01-16 22:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('under_line', models.IntegerField()),
                ('schedule', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='odds', to='Hockey_I.ScheduleNHL')),
            ],
        ),
        migrations.CreateModel(
            name='BetTaker',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('betslip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='betslip_bettakers', to='Hockey_I.BetSlip')),
                ('event_odds', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bettaker_event_odds', to='Hockey_I.OddsNHL')),
                ('schedule_event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bettaker_event', to='Hockey_I.ScheduleNHL')),
        ...
        migrations.AddField(
            model_name='betslip',
            name='event_odds',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_odds', to='Hockey_I.OddsNHL'),
        ),
        migrations.AddField(
            model_name='betslip',
            name='schedule_event',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='event', to='Hockey_I.ScheduleNHL'),
        ),
        migrations.AddField(
            model_name='betslip',
            name='user',
