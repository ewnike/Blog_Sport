# Generated by Django 2.2 on 2020-01-07 19:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('under_line', models.IntegerField()),
                ('schedule', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='odds', to='hockey.ScheduleNHL')),
            ],
        ),
        migrations.CreateModel(
            name='BetTaker',
