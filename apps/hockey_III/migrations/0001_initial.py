# Generated by Django 2.2 on 2020-01-28 01:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='odds', to='hockey_III.ScheduleNHL')),
            ],
        ),
        migrations.CreateModel(
            name='BetTaker',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('betslip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='betslip_bettakers', to='hockey_III.BetSlip')),
                ('event_odds', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bettaker_event_odds', to='hockey_III.OddsNHL')),
                ('schedule_event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bettaker_event', to='hockey_III.ScheduleNHL')),
        ...
        migrations.AddField(
            model_name='betslip',
            name='event_odds',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_odds', to='hockey_III.OddsNHL'),
        ),
        migrations.AddField(
            model_name='betslip',
            name='schedule_event',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='event', to='hockey_III.ScheduleNHL'),
        ),
        migrations.AddField(
            model_name='betslip',
            name='user',
